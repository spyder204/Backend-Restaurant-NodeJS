...
.post(authenticate.verifyUser, authenticate.verifyAdmin, (req, res, next) => {  // for POST req. authenticate.verifyUser would be executed, if success, then callback runs
